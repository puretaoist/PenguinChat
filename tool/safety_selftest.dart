...
Future<void> main() async {
  ...
  try {
    ...
    print('\n[闸门] 开启真实服务器需逐条确认');
    {
      ...
      final r3 = await gate.enableRealServer(full);
